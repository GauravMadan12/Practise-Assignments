...
console.log("Product of two no's is: " + product(5,5))
console.log("--------------------------------------------------------------")
...
var text = "Hello!"
console.log("Array of given string is: " + text.split(""))
console.log("--------------------------------------------------------------")
...
//console.log(fruits)
fruits.push("Grapes")
console.log("Adding element: " + fruits)
...
var x = 9.656
console.log("Integer to string: " + x.toString()) 
console.log("Two decimal places: " + x.toExponential(2))
console.log("--------------------------------------------------------------")
...
var x = 7.65
console.log("Nearest Value: " + x.toPrecision(1))
...
console.log("Sorted array is: " + points.sort() )  //*****doubt